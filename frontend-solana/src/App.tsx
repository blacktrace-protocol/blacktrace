...
import { AliceSettlementSolana } from './components/AliceSettlementSolana';
import { BobSettlementSolana } from './components/BobSettlementSolana';
import { SettlementQueue } from './components/SettlementQueue';
import { WalletBalanceSolana } from './components/WalletBalanceSolana';
// Solana frontend - ZEC <-> SOL atomic swaps
import { Tabs, TabsContent, TabsList, TabsTrigger } from './components/ui/tabs';
import { Shield, LogOut, Coins } from 'lucide-react';
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  ZEC ↔ SOL Atomic Swap Demo
                </p>
              </div>
            </div>
            <div className="flex items-center gap-2 text-sm text-purple-400 bg-purple-950/20 px-3 py-1.5 rounded-full border border-purple-900">
              <Coins className="h-4 w-4" />
              <span>Solana HTLC (SHA256)</span>
            </div>
          </div>
        </div>
      </div>
            ...
            {!aliceUser ? (
              ...
              <Tabs defaultValue="wallet" className="w-full">
                ...
                <TabsContent value="wallet">
                  <WalletBalanceSolana user="alice" />
                </TabsContent>
                ...
                <TabsContent value="settlement">
                  <AliceSettlementSolana onCountChange={setAliceSettlementCount} />
                </TabsContent>
              </Tabs>
            )}
          </div>
          ...
          <div className="space-y-4">
            ...
            {!bobUser ? (
              ...
              <Tabs defaultValue="wallet" className="w-full">
                ...
                <TabsContent value="settlement">
                  <BobSettlementSolana onCountChange={setBobSettlementCount} />
                </TabsContent>
              </Tabs>
            )}
          </div>
