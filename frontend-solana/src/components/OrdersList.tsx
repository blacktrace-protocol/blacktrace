...
import { ShoppingCart, Coins, RefreshCw, Unlock } from 'lucide-react';
            ...
            return (
              ...
              <div className="grid grid-cols-2 gap-4 mb-3">
                <div>
                  ...
                  <div className="text-lg font-semibold">
                    {order.amount === 0 ? '???' : (order.amount / 100000000).toFixed(4)} ZEC
                  </div>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4 mb-3">
                <div className="flex items-center gap-1 text-sm">
                  ...
                  <span className="font-medium">{order.amount === 0 ? '???' : (order.min_price / 1000000000 || 0).toFixed(4)} SOL</span>
                </div>
                <div className="flex items-center gap-1 text-sm">
                  <Coins className="h-3 w-3" />
                  <span className="text-muted-foreground">Max:</span>
                  <span className="font-medium">{order.amount === 0 ? '???' : (order.max_price / 1000000000 || 0).toFixed(4)} SOL</span>
                </div>
              </div>
